...
ImageFile.LOAD_TRUNCATED_IMAGES = True  # queue可能出现错误以外截断图像数据,使用次命令忽略错误并强制执行
...
class Tool:
    ...
    def place_text(img, text, fontsize, x_offset=0, y_offset=0):  # 在图像上绘制文字
        ...
        font = ImageFont.truetype('TTF/FZFSJW.TTF', fontsize, encoding="utf-8")  # 如果字体文件侵权请告知删除
...
class SPC:  # 旋转编码器控制
    ...
    def RK_IN():
        ...
        EPD.full_img = Image.open("images/white.png")

        img_OFF = Image.open("images/OFF.png")
        ...
        while True:
            ...
            if run == 0:
                ...
                if cmd == 1:
                    ...
                    os.popen('cd Video && python3 py_face_dlib.py')
...
class APP: 
    ...
    def hello_word():
        ...
        img_ON = Image.open("images/ON.png")
        ...
        for i in range(7):
            ...
            img = Image.open("images/0%s.png"% i)
    ...
    def desktop(KEY):  
        ...
        try:
            ...
            ink_pt_img = Image.open('images/ink_pt.png')  # 指针材质
    ...
    def ebook(Pin):
        ...
        try:
            ...
            img = Image.open("images/book/%s.png"% page_number)
    ...
    def nowTime(KEY):
        ...
        font_L = ImageFont.truetype("ttf from China/STXIHEI.TTF", 60, encoding="utf-8")  # 初始化STXIHEI字体为大号
    
        font_M = ImageFont.truetype("ttf from China/STXIHEI.TTF", 40, encoding="utf-8")  # 初始化STXIHEI字体为中号
    
        font_S = ImageFont.truetype("ttf from China/STXIHEI.TTF", 30, encoding="utf-8")  # 初始化STXIHEI字体为小号

        img_S = Image.open('images/S.png').convert("RGBA")  

        img_M = Image.open('images/M.png').convert("RGBA")  

        img_T = Image.open('images/T.png').convert("RGBA")  

        oclock = Image.open('images/oclock_A.png').convert("RGBA")  
        ...
        while True:
            ...
            try:
                ...
                if Time <= 10 and Time >= 4:
                    ...
                    memo = Image.open("images/t_1.jpg")

                elif Time > 10 and Time <= 18:

                    memo = Image.open("images/t_2.jpg")

                else:

                    memo = Image.open("images/t_3.jpg")
