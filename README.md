...
**制作过程请移步** [【自制】树莓派+IT8951+Epaper+Python开源终端【硬核】_哔哩哔哩_bilibili](https://www.bilibili.com/video/BV1uP4y1x7pL)
...
本项目使用了一块7075航空铝板作为背面外壳。因为树莓派4B的CPU发热量较大，7075航空铝材背板起到固定以及散热作用。而其他部分采用较为柔软的KT泡沫板作为材料搭建，能够很好的于屏幕贴合保护屏幕。
